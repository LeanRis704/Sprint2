...
function agregarPersonas() {
    ...
    if(contador != personas){
        window.alert("Error! La cantidad de personas no está definida o no ha introducido ningún número!");
        return;
    }
...
function sumar(){
    ...
    cartel.innerHTML = `<h1>¡Cada persona deberá aportar ${resultado} pesos!</h1>`;
    cartel.innerHTML += `<button onclick=\"reload()\">¡Realiza un nuevo cálculo!</button>`;
